...
exports.updateProduct = exports.getSingleProduct = exports.getProducts = exports.deleteProduct = exports.addProduct = void 0;
...
var storage = _multer["default"].diskStorage({
  destination: function destination(req, file, cb) {
    if (_fs["default"].existsSync("./uploads/product")) {
      cb(null, "./uploads/product");
    } else {
      _fs["default"].mkdirSync("./uploads/product");
      cb(null, "./uploads/product");
    }
  },
...
var addProduct = exports.addProduct = function addProduct(req, res) {
  try {
    var dataWithImages = upload.fields([{
      name: "thumbnail",
      maxCount: 1
    }, {
      name: "images",
    ...
    dataWithImages(req, res, function (err) {
      ...
      if (req.files) {
        ...
        if (req.files["images"]) {
          for (var i = 0; i < req.files["images"].length; i++) {
            var element = req.files["images"][i];
            imgArr.push(element.filename);
          }
        }
      }
      var productData = new _product["default"]({
        title: title,
        brand: brand,
        category: category,
...
var getProducts = exports.getProducts = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(req, res) {
    var _req$query, search, limit, page, sort, skipno, pipeLine, rgx, searchRgx, filter, sortField, productsData, currentDate;
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          _req$query = req.query, search = _req$query.search, limit = _req$query.limit, page = _req$query.page, sort = _req$query.sort;
          skipno = limit * (page - 1);
          _context.prev = 2;
          pipeLine = [{
            $lookup: {
          ...
          rgx = function rgx(pattern) {
            return new RegExp(".*".concat(pattern, ".*"));
          };
          searchRgx = rgx(search);
          filter = {};
          sortField = ["_id", 1];
          if (sort == "htl") {
            sortField = ["price", -1];
          ...
          _context.next = 13;
          return _product["default"].aggregate(pipeLine);
        case 13:
          ...
          productsData.forEach(function (product) {
            var productDate = new Date(product.day);
            if (currentDate.toDateString() === productDate.toDateString()) {
              ...
              product.day = productDate.toLocaleString("default", {
                month: "short"
              }) + " " + productDate.getDate();
            }
          });
...
var getSingleProduct = exports.getSingleProduct = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(req, res) {
    var productId, productdata;
...
var updateProduct = exports.updateProduct = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(req, res) {
    var _req$body2, title, brand, category, description, price, productId, updatedProduct;
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _req$body2 = req.body, title = _req$body2.title, brand = _req$body2.brand, category = _req$body2.category, description = _req$body2.description, price = _req$body2.price;
          productId = req.params.product_id;
          _context3.next = 5;
        ...
        case 11:
          ...
          return _context3.abrupt("return", res.status(500).josn({
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 10:
          ...
          return _context4.abrupt("return", res.status(500).josn({
