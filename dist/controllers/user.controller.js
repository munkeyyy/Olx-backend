...
exports.updateUser = exports.signUp = exports.signIn = exports.getUsers = exports.getSingleUser = exports.deleteUser = exports.addUser = void 0;
...
var storage = _multer["default"].diskStorage({
  destination: function destination(req, file, cb) {
    if (_fs["default"].existsSync("./uploads/users")) {
      cb(null, "./uploads/users");
    } else {
      _fs["default"].mkdirSync("./uploads/users");
      cb(null, "./uploads/users");
    }
  },
...
var addUser = exports.addUser = function addUser(req, res) {
  try {
    var dataWithImage = upload.single("avatar");
  ...
  var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(req, res) {
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          _context4.prev = 0;
          dataWithImage = upload.single("avatar");
          dataWithImage(req, res, /*#__PURE__*/function () {
            var _ref4 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(err) {
              var userId, existData, _req$body2, user_name, email, password, phone, image, updatedUser;
              return _regeneratorRuntime().wrap(function _callee3$(_context3) {
                while (1) switch (_context3.prev = _context3.next) {
                  ...
                  case 7:
                    ...
                    _req$body2 = req.body, user_name = _req$body2.user_name, email = _req$body2.email, password = _req$body2.password, phone = _req$body2.phone;
                    image = existData.avatar;
                    console.log("EXIST", image);
                    if (req.file) {
                      image = req.file.filename;
                      if (_fs["default"].existsSync("./uploads/users/" + existData.avatar)) {
                        _fs["default"].unlinkSync("./uploads/users/" + existData.avatar);
                      }
...
var deleteUser = exports.deleteUser = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee5(req, res) {
    var userId, existData, deletedUser;
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 7:
          ...
          if (_fs["default"].existsSync("./uplaods/users/" + existData.avatar)) {
            _fs["default"].unlinkSync("./uploads/users/" + existData.avatar);
          }
...
var signUp = exports.signUp = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee6(req, res) {
    var _req$body3, user_name, email, password, phone, existUser, hashedPassword;
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        case 0:
          _context6.prev = 0;
          _req$body3 = req.body, user_name = _req$body3.user_name, email = _req$body3.email, password = _req$body3.password, phone = _req$body3.phone;
          _context6.next = 4;
          return _user["default"].findOne({
            email: email
          });
        ...
        case 7:
          ...
          return _context6.abrupt("return", _user["default"].create({
            user_name: user_name,
            email: email,
  ...
  return function signUp(_x10, _x11) {
    return _ref6.apply(this, arguments);
  };
}();
var signIn = exports.signIn = /*#__PURE__*/function () {
  var _ref7 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee7(req, res) {
    var _req$body4, email, password, existUser, checkPassword, token;
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 7:
          checkPassword = _bcrypt["default"].compareSync(password, existUser.password);
          if (checkPassword) {
            _context7.next = 10;
            break;
          }
